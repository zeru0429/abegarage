      ...
      <div className="row">
        ...
        <div className="col-8 pt-4">
          ...
          <div className="contact-form">
            ...
            { !selectedCustomer && <div className="form-group col-md-12 mb-0 pb-0">
                <input
                  type="text"
                  name="userInput"
              ...
              {customers.length !== 0 ? ( !selectedCustomer &&
                      ...
                      customers.map((singleCustomer) => {
                        return (
                          <tr key={singleCustomer.customer_id}>
                            ...
                            <td>
                              <PanToolAltIcon onClick={() => handleSelectCustomer(singleCustomer)} />
                            </td>
                          </tr>
                        );
                      })}
               ...
               {/* content three */}
               {selectedCustomer && <div className="container mb-2" style={{backgroundColor: 'white'}}>
                <div className="row">
                <div className="col-10 p-4">
                    <h5 className='pb-3'>
                      <b>{selectedCustomer.customer_first_name} {selectedCustomer.customer_last_name}</b>
                    </h5>
                    <div>
                      <b>Email: </b> <span className='text'> {selectedCustomer.customer_email}</span>
                    </div>
                    <div>
                      <b>Phone: </b> <span className='text'>{selectedCustomer.customer_phone_number}</span>
                    </div>
                    <div>
                      <b>Active Customer: </b><span className='text'>{selectedCustomer.active_customer_status==1? 'Yes' : 'No'}</span>
                    </div>
                    <div>
              ...
              {vehicle && selectedCustomer && <div className="container mt-2" style={{backgroundColor: 'white'}}>
                <div className="row pt-5" >
                    <div className="col-12">
                      ...
                      <Table striped bordered hover>
                          ...
                          <tbody>
                          {vehicle.length<1 && <tr className="text"> <td> no vehicle found</td> </tr>}
                          {vehicle && vehicle.map((singleVehicle)=>{
                            return <tr key={singleVehicle.vehicle_id}>
                                    ...
                                    <td><PanToolAltIcon onClick={()=>{setSelectedVehicles(singleVehicle);fetchServices();}} /></td>
                                  </tr>
                          })}
                          </tbody>
                      </Table>
          ...
          {/* content four */}  
          {selectedVehicle &&  <div className="container m-2 p-2" style={{backgroundColor: 'white'}}>
              <div className="row">
                <div className="col-10 p-4">
                    <h5 className='pb-3'>
                    ...
                    <div>
                      <b>Vehicle color : </b> <span className='text'>{selectedVehicle.vehicle_color}</span>
                    </div>
                    <div>
                      <b>Vehicle tag: </b> <span className='text'> {selectedVehicle.vehicle_tag}</span>
                    </div>
                    <div>
                      <b>Vehicle year : </b> <span className='text'> {selectedVehicle.vehicle_year}</span>
                    </div>
                    <div>
                      <b>Vehicle mileage : </b> <span className='text'>{selectedVehicle.vehicle_mileage} </span>
                    </div>
                    <div>
                      <b>Vehicle serial: </b> <span className='text'>{selectedVehicle.vehicle_serial}</span>
                    </div>
          ...
          {garageService && garageService.map((singleService) => (
             <div key={singleService.service_id} className="conatainer m-2 p-2" style={{background: 'white'}} >
             <div className="row  m-0 p-0">
                 <div className="col-12">
                   <h5><b>{singleService.service_name}</b></h5>
                 </div>
               </div>
               <div className="row m-0 p-0">
                   <div className="col-10">
                     <p className='text'>{singleService.service_description}</p>
                   </div>
                   <div className="col-1">
                   <Checkbox
                      onClick={() => {
                        setForm((form) => ({
                          ...form,
                          service: [...form.service, singleService.service_id],
                        }));
                      }}
                    />
                   </div>
          ...
          <div className="container mt-2 mb-5 p-5" style={{background: 'white'}} >
          {garageService.length>0 && <AdditionalRequestForm hadleSubmit={hadleSubmit} form={form} setForm={setForm} errors={errors} setErrors={setErrors} /> }
          </div>
            </div>
          </div>
        </div>
